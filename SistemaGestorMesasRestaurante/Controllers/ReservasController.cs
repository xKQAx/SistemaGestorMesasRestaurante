...
namespace SistemaGestorMesasRestaurante.Controllers
{
    public class ReservasController : Controller
    {
        ...
        public ReservasController(SistemaGestionContext context)
        {
            _context = context;
        }
        ...
        {
            var sistemaGestionContext = _context.Reservas.Include(r => r.Cliente).Include(r => r.Horario).Include(r => r.Mesa);
        ...
        public async Task<IActionResult> Create([Bind("ReservaId,ClienteId,MesaId,HorarioId,FechaReserva,Estado")] Reserva reserva)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReservaId,ClienteId,MesaId,HorarioId,FechaReserva,Estado")] Reserva reserva)
        {
