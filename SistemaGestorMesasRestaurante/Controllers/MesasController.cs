...
namespace SistemaGestorMesasRestaurante.Controllers
{
    public class MesasController : Controller
    {
        ...
        public MesasController(SistemaGestionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MesaId,NumeroMesa,Capacidad,Ubicacion")] Mesa mesa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MesaId,NumeroMesa,Capacidad,Ubicacion")] Mesa mesa)
        {
            if (id != mesa.MesaId)
            {
                return NotFound();
